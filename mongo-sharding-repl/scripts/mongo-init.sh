...
rs.initiate({
    _id: "shard1",
    members: [
        { _id: 0, host: "shard1_1:27020", priority: 5 },
        { _id: 1, host: "shard1_2:27020", priority: 3 },
        { _id: 2, host: "shard1_3:27020", priority: 1 }
    ]
})
EOF
...
rs.initiate({
    _id: "shard2",
    members: [
        { _id: 0, host: "shard2_1:27021", priority: 5 },
        { _id: 1, host: "shard2_2:27021", priority: 3 },
        { _id: 2, host: "shard2_3:27021", priority: 1 }
    ]
})
EOF
...
sh.addShard("shard1/shard1_1:27020,shard1_2:27020,shard1_3:27020")
sh.addShard("shard2/shard2_1:27021,shard2_2:27021,shard2_3:27021")
...
for(var i = 0; i < 6000; i++) db.helloDoc.insertOne({age:i, name:"ly"+i})
EOF
